...
export default function Home() {
  ...
  return (
    <form onSubmit={onPrompt} class={tw`h-full flex flex-col`}>
      ...
      <div
        class={tw
          `h-16 px-5 flex items-center justify-between bg-gray-100 border border-gray-200`}
      >
        ...
        <div class={tw`flex items-center justify-between gap-4`}>
          ...
          <button
            type="submit"
            class={tw
              `rounded py-1 px-5 transition bg-black text-white border-2 border-black outline-none hover:text-black hover:bg-white disabled:text-black disabled:bg-gray-200 disabled:border-gray-200 disabled:cursor-not-allowed`}
      ...
      <textarea
        id="prompt"
        class={tw
          `flex-grow outline-none px-4 py-2 text-sm w-full resize-none border-r-1 border-gray-200 min-h-[300px]`}
